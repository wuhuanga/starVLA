#!/bin/bash
# RIDE-VLA | LIBERO | Locus Ablation: All Hidden States
# Distillation target: mean-pooled full last-layer hidden states [B, H].
# Tests whether a coarser, whole-sequence representation constraint is sufficient.
...
run_id=LIBERO_locus_all_hidden
###########################################################################################
...
accelerate launch \
  ...
  --framework.distill_locus all_hidden \
