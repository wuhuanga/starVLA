#!/bin/bash
# RIDE-VLA | LIBERO | Aug. Only Baseline
# Perturbed input (visual aug + paraphrase), action loss only — no teacher, no distillation.
# Tests whether standard data augmentation alone explains the robustness gain.
...
accelerate launch \
  ...
  --framework.train_variant aug_only \
