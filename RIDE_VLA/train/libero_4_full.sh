#!/bin/bash
# RIDE-VLA | LIBERO | Full Method (Language + Visual Distillation)
# Teacher: clean image + original instruction (EMA)
# Student: visual-augmented image + paraphrased instruction
# Loss: student action + teacher action auxiliary + representation distillation
