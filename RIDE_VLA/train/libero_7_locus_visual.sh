#!/bin/bash
# RIDE-VLA | LIBERO | Locus Ablation: Visual Tokens
# Distillation target: mean-pooled visual-token hidden states [B, H] (before LLM layers).
# Tests whether anchoring invariance at the visual projector level is sufficient.
