#!/bin/bash
# RIDE-VLA | SimplerEnv | Locus Ablation: Output (Velocity)
# Distillation target: action-head velocity MSE with shared (s, eps) noise.
# EMA teacher on clean view; student on perturbed view.
# Only action-query tokens kept → batch 16 like full method.
